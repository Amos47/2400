...
Right up front let's get clear on something. **Wikipedia cannot be used to do science any more than my mother's grand Irish sayings.** My use of Wikipedia in this book is to encourage thoughtful discussion and not to provide any kind of proof; you will always get my interpretation of the issue at hand and often get other sources with which to augment or compare. Such is academics. 
