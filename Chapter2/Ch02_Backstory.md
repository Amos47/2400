...
A wealth of data can be collected through embedding beacons in everything from our own bodies to our vehicles (both commercial and personal) and in our aircraft (the famous *black box* is a beacon, allowing searchers to locate a downed airplane if they can find it before box's transmitter runs out of power - and that's a challenge you might want to take if you're at all engineering and entreprenurial in nature. Imagine the lives you could save by architecting a self-sustaining black box!). And again, all this data can be collected for further analysis, surveillance and prediction. This is true *context.*
