...
Representing the triangle rather as spheres is brilliant. I credit (though I don't know if it was they who first represented it this way) an organisation called [Contract Standards](https://kmstandards.com/wpblog/2014/10/). The spheres allow good old Venn Diagrammatic logic, where the area of intersection of spheres has specific significance. Each sphere represents one of the big three in Project Management (PM). The farther away from the intersection of all three (the Jolly Roger symbol in the centre) we move, the more of the characteristic a system will have. The arrows point in the direction of more *speed* (faster delivery), more *quality* (a good product) and more *economy* (lower cost). At the very centre, at the intersection of all three, we have the Jolly Roger. This is a perfectly balanced system, having some of each of the three characteristics but not being particularly outstanding in any one. Such a system, while buildable, would be a hard sell. It would have some good qualities, would take a fairly long time to build and deliver (speed) and would be fairly expensive. Why build it? Furthermore, the triangle and the spheres all indicate that you can have some measure of two things, but the third will inevitable suffer. If you want a system of high quality and you want it quickly, then it will be expensive (low speed). If you want an economical system and you want it right away, quality will suffer. This makes intuitive sense. If you want a system that's affordable but of high quality, you'll have to wait for it coz it ain't happening tomorrow. This is the logic of the PMT.
