...
Let’s begin at the left of this Figure, and consider the “Type of work and done by” column. We start at the bottom, left corner of the figure, with the colour-coded Machine / Human distinction. The things above it are all activities performed in all organisations on a regular basis (measurement, data collection/storage, etc.). Most of these activities we have seen before from examining Figure LLJJ (Chapter 2) in depth. The leftmost column seeks to inform regarding the relative contribution of human versus machine in the execution of the task activities stacked up on this dimension. The more yellow the activity box, the more humans are the nexus of activity in this particular domain. Conversely, the more black, the more machines are the ones doing the work in this domain. 
