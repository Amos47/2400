...
There are multiple reasons for these seismic shifts, but the nuances are best left to the labour economists and policy wonks. For our purposes, it matters not at all _why_, but rather only _that_. And it matters for the remainder of the so-called _advance economies_ (among which [Canada ranked 11th](http://data.worldbank.org/data-catalog/GDP-ranking-table) in terms of the size of our economy by GDP in 2013) as well.  All advanced economies have experienced the same shift over the same period, and the economies of the currently modernising countries (China, India, Brazil among others) will experience the same shift towards intangible, knowledge-based contribution to GDP. 
