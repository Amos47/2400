...
###Decisions, decisions, decisions (sung to the tune of Marcia, Marcia, Marcia!)
...
In considering organisational levels, we need to talk about how stuff gets done; about what strategy is and how a strategic direction gets set and translated into actionable directives in an organisation. A simple analogy is found in war. At the highest level, strategy gets made in the smoky war rooms. General Highbottom declares: “In order to win this battle, we must take control of that hill!” Next comes the tactical level, which makes possible the strategic. Colonel Middlestaff receives the strategic direction from Highbottom and declares that in order to take that hill, “We’ll need 100 soldiers and 10 tanks and 5 mortars and 3 APCs. Split the infantry soldiers into two groups. Send 50 to the back of the hill with the mortars. Bring 5 tanks in from each flank. Send 50 infantry up the hill in the APCs once the tanks and mortars have disbursed the enemy and weakened their resistance.” Middlestaff then pushes the tactical plan down the line to Captain Getterdunn, who works at the operational level, at the interface with the enemy. Getterdunn receives the tactical directives, is given access to the human and physical resources and proceeds to organise and execute the plan, with the help of subordinates such as Sergeant Barkenspitz, according to the tactical directives. The soldiers are equipped, taken into battle and expected to succeed.  Getterdunn reports at regular intervals on how the battle is progressing. Et _voila_. From strategy to operation. 

The similarity to an organisational reality is striking… fix this mess. 
...
MIS help firms to manage the myriad processes that must be managed on a day-to-day basis. They aren’t about strategy but are rather about operations. Boots on the ground. They deal in data that is of low to medium granularity, cost and complexity.  They process structured data. They sort, prioritise, merge data from different internal sources and then summarise. Thus they provide rich context. They will also tell you anything you want to know about what they have done. They have excellent reporting facilities but can’t tell you about the future. They deal strictly in the past up to the present. They are not at all strategic. 

Next up are _Decision Support Systems_. 
