...
And just to throw a wrench into the works, the notion of human _spirit_ and a _soul_ play large in this debate. If everything analog can eventually be represented by a series of bits to the point where we can’t tell, then are people simply huge binary machines, as are computers, made up of such minute and many binary objects that we simply can’t tell? Take a biochemistry course. Take philosophy courses. Everyone should. You aren’t complete without them. The truth is out there ;) 
