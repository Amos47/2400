...
Next note that there are sometimes other *ghosted* images clustered around a darker image (as is the case with the cave dude in the topmost communication form - speech from person to person. On the right, there is one principal and several secondary dudes. This indicates that there could be more than one person on this end of the communication. A cave dude might be talking to one other among the cohort, bit others might well be passive listening or enen in a rudimentary *audience* as it were. So the Mode of communication (see the column just to the right named *Mode*) is 1:m, meaning *one source* but *many destinations* are possible. Dude could be talking to one person or a crowd, but the message is the same for all. 
