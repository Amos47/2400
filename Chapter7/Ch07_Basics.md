...
## Tools
Data analysis tools are every bit as important as the data itself. Without them, most data would remain uncategorised, unanalysed with its information potential locked away forever. So let's take a look at some analysis tools. We begin with a demonstration of analysis in the form of an interactive infographic from tableau.com, an important player in the cloud anslytics space. 
