...
On the other hand, scores coming in low on both dimensions (less than 50% on both measures) would locate the programme in the Eliminate quadrant, making it a prime candidate for elimination altogether. It's a dog. 
...
What are the issues? First of all, we have chosen arbitrary cut points between decision outcomes, located at 50% on each scale. This is aesthetically quite pleasing (yielding four, nice, equally-sized quadrants), but is unlikely to represent reality in all but the most unusual cases. More likely is the organisation having different cultures, priorities, strategies and practices, thus requiring different cut-points.

**Figure ETA. Decision Matrix examples with different variable cut points**
...
The *half camp* exists in the region between the SDLC and the Adaptive methods. This is *prototyping*. Not quite prescriptive and not quite adaptive, but shading towards the latter. Prototyping is often referred to as an *iterative* method as the system is created in successive iterations (versions). 
...
**Figure XCB. SDLC waterfall phases** 
...
In fact, risk remains higher in SDLC-type (waterfall) projects than in agile-type (iterative) projects until the very end of the process. This is at least *partly* a function of the method itself, and partly a function of the type of project that matches with the method. While we are skipping ahead here a little inasmuch as we haven't yet discussed Agile methods, Figure nonetheless BCR shows the differential cost expressed by the risk of finding errors in a systems development *milieu* in the procurement industry.  

**Figure BCR. Risk comparison between SDLC and Agile/Adaptive/Iterative development.**
