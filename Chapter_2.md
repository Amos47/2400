...
A wealth of data can be collected through embedding beacons in everything from our own bodies to our vehicles (both commercial and personal) and in our aircraft (the famous *black box* is a beacon, allowing searchers to locate a downed airplane if they can find it before black box's transmitter runs out of power). And again, all this data can be collected for further analysis, surveillance and prediction. This is true *context.*
