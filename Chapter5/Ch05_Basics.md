...
So let's boil that down to what *I think* are the main reasons people use SM. Here's my list (you are free to disagree):
...
Considering the first four above, there's nothing *particularly special* about social media as opposed to other forms of human interaction. We use SM in much the same way we have used newspapers and magazines, libraries, movie theatres, radio and TV in the past. But what *is* different is the ability SM gives us (individually) to reach out to a wide audience, and to receive from a wide variety of sources, both in near real time. This *marketing of personal brand* is unprecedented in history. We do need to ask though, with everyone doing personal marketing on such a grand scale, is there enough time to listen? Coupled with that is the stark reality that we hide our true selves when using SM. Hide, or maybe create an online persona which is not really *representative* of who we are. Our *selfie self* is a fake. I'm sure you can see this in others... 
...
Step 1: I will refine the definition of Social Media from Wikipedia (above) to: *Any technology that allows the sending and/or receipt of messages to and/or from one or more members of your relevant social network of family and either existing or potential friends, contacts, employers, lovers or haters.* (A long list of SM appears above in this Chapter).
